...
class NotificationRepositoryImpl : NotificationRepository {
    ...
    override suspend fun create(userId: Long, request: CreateNotificationRequest): Notification {
        val notificationId = newSuspendedTransaction {
    ...
    override suspend fun getByUser(userId: Long): List<Notification> = newSuspendedTransaction {
    ...
    private suspend fun getById(id: Long): Notification? = newSuspendedTransaction {
