...
object ImageUrlResolver {
    ...
    fun resolveImages(jsonString: String?, uploadUrlMap: Map<String, String>): String {
        if (jsonString.isNullOrBlank()) return "[]"

        val images: List<String> = gson.fromJson(jsonString, listType)
        val resolvedImages = images.map { imageUrl ->
     ...
     fun resolveImage(imageUrl: String?, uploadUrlMap: Map<String, String>): String? {
